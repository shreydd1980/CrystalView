...
public class FCCGenerator : MonoBehaviour
{
    ...
    public void GenerateFCC()
    {
        ...
        HashSet<Vector3> facePositions = new HashSet<Vector3>();
        ...
        // Generate face-centered atoms (each face of each unit cell)
        for (int i = 0; i < nx; i++)
            for (int j = 0; j < ny; j++)
                for (int k = 0; k < nz; k++)
                {
                    ...
                    // XY faces
                    facePositions.Add(cellOrigin + new Vector3(0.5f * a, 0.5f * a, 0));
                    facePositions.Add(cellOrigin + new Vector3(0.5f * a, 0.5f * a, -a));
                    // YZ faces
                    facePositions.Add(cellOrigin + new Vector3(0, 0.5f * a, -0.5f * a));
                    facePositions.Add(cellOrigin + new Vector3(a, 0.5f * a, -0.5f * a));
                    // XZ faces
                    facePositions.Add(cellOrigin + new Vector3(0.5f * a, 0, -0.5f * a));
                    facePositions.Add(cellOrigin + new Vector3(0.5f * a, a, -0.5f * a));
                }
        ...
        // Only connect bonds between corner atoms along cube edges (not diagonals, not to face atoms)
