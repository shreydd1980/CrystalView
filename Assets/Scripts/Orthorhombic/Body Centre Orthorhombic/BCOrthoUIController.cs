...
public class BCOrthoUIController : MonoBehaviour
{
    public BCOrthoGenerator generator;
    ...
    void Start()
    {
        ...
        if (generator == null)
        {
            Debug.LogError("BCOrthoGenerator reference is missing!");
            return;
        }
    ...
    void Regenerate()
    {
        ...
        generator.GenerateBodyCenteredOrthorhombic();
    }
    ...
    // Methods for common body-centered orthorhombic crystal examples
    public void SetCelestiteExample()
    {
        // Celestite (SrSO4) - body-centered orthorhombic
        generator.a = 1f;
    ...
    public void SetAnglesiteExample()
    {
        // Anglesite (PbSO4) - body-centered orthorhombic
        generator.a = 1f;
    ...
    public void SetChrysotileExample()
    {
        // Chrysotile (Mg3Si2O5(OH)4) - body-centered orthorhombic
        generator.a = 1f;
        generator.b = 1.83f; // b/a ≈ 1.83
        generator.c = 0.73f; // c/a ≈ 0.73
        UpdateUIFromGenerator();
        Regenerate();
    }
    ...
    public void SetElongatedBCOrtho()
    {
        // c > b > a (elongated along c)
        SetAxisRatios(1.3f, 1.9f);
    }

    public void SetFlattenedBCOrtho()
    {
        // a > b > c (flattened along c)
        SetAxisRatios(0.8f, 0.6f);
    }

    public void SetNearCubicBCOrtho()
    {
        // a ≈ b ≈ c (nearly cubic, but still orthorhombic)
        SetAxisRatios(0.97f, 0.93f);
    }

    // Method to randomize axis ratios for exploration
    public void RandomizeAxisRatios()
    {
        float bOverA = Random.Range(0.6f, 2.0f);
        float cOverA = Random.Range(0.5f, 1.8f);
    ...
    // Additional BCO-specific controls
    ...
    // Method to demonstrate the difference between simple and body-centered orthorhombic
