...
public class BCOrthoGenerator : MonoBehaviour
{
    ...
    void Start()
    {
        GenerateBodyCenteredOrthorhombic();
    }

    public void GenerateBodyCenteredOrthorhombic()
    {
        ...
        // Do NOT connect body center atoms to corners or to each other
