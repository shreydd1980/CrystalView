...
public class FCOrthoUIController : MonoBehaviour
{
    public FCOrthoGenerator generator;
    ...
    void Start()
    {
        ...
        if (generator == null)
        {
            Debug.LogError("FCOrthoGenerator reference is missing!");
            return;
        }
    ...
    void Regenerate()
    {
        ...
        generator.GenerateFaceCenteredOrthorhombic();
    }
    ...
    // Methods for common face-centered orthorhombic crystal examples
    public void SetCelestineExample()
    {
        // Celestine (SrSO4) - face-centered orthorhombic
        generator.a = 1f;
        generator.b = 1.25f; // b/a ≈ 1.25
        generator.c = 0.78f; // c/a ≈ 0.78
        UpdateUIFromGenerator();
        Regenerate();
    }

    public void SetAragoniteExample()
    {
        // Aragonite (CaCO3) - face-centered orthorhombic
        generator.a = 1f;
        generator.b = 1.27f; // b/a ≈ 1.27
        generator.c = 1.15f; // c/a ≈ 1.15
        UpdateUIFromGenerator();
        Regenerate();
    }

    public void SetMarcasiteExample()
    {
        // Marcasite (FeS2) - face-centered orthorhombic
        generator.a = 1f;
        generator.b = 1.09f; // b/a ≈ 1.09
        generator.c = 0.89f; // c/a ≈ 0.89
        UpdateUIFromGenerator();
        Regenerate();
    }

    public void SetCerussiteExample()
    {
        // Cerussite (PbCO3) - face-centered orthorhombic
        generator.a = 1f;
        generator.b = 0.84f; // b/a ≈ 0.84
        generator.c = 1.18f; // c/a ≈ 1.18
        UpdateUIFromGenerator();
        Regenerate();
    }
    ...
    public void SetElongatedFCOrtho()
    {
        // c > b > a (elongated along c)
        SetAxisRatios(1.3f, 1.8f);
    }

    public void SetFlattenedFCOrtho()
    {
        // a > b > c (flattened along c)
        SetAxisRatios(0.8f, 0.6f);
    }

    public void SetNearCubicFCOrtho()
    {
        // a ≈ b ≈ c (nearly cubic, but still orthorhombic)
        SetAxisRatios(0.96f, 0.92f);
    }
    ...
    // Additional FCO-specific controls
    public void ShowFaceCenterAtoms()
    {
        // Method to highlight or change color of face-center atoms
        // This would require modification to the generator to track which atoms are face-centered
        Debug.Log("Face-center atoms visualization - requires generator modification");
    }
    ...
    {
        // Method to show both corner and face-center atoms with different colors
        Debug.Log("Both atom types - requires generator modification");
    }

    // Method to demonstrate the difference between simple and face-centered orthorhombic
