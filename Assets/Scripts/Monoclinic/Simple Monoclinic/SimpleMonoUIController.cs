...
public class SimpleMonoUIController : MonoBehaviour
{
    public SimpleMonoGenerator generator;
    ...
    void Start()
    {
        ...
        if (generator == null)
        {
            Debug.LogError("SimpleMonoGenerator reference is missing!");
            return;
        }
    ...
    // Methods for common monoclinic crystal examples
    public void SetGypsumExample()
    {
    ...
    public void SetOrthoclaseExample()
    {
    ...
    public void SetAugiteExample()
    {
        // Augite (Ca,Mg,Fe,Al)2(Si,Al)2O6 - monoclinic
        generator.a = 1f;
        generator.b = 0.89f; // b/a ≈ 0.89
        generator.c = 0.55f; // c/a ≈ 0.55
        generator.gamma = 74; // γ ≈ 74°
        UpdateUIFromGenerator();
        Regenerate();
    }

    public void SetEpidoteExample()
    {
        // Epidote (Ca2(Al,Fe)3Si3O12OH) - monoclinic
        generator.a = 1f;
        generator.b = 0.59f; // b/a ≈ 0.59
        generator.c = 0.69f; // c/a ≈ 0.69
        generator.gamma = 65; // γ ≈ 65°
        UpdateUIFromGenerator();
        Regenerate();
    }
    ...
    public void SetElongatedMono()
    {
        // c > b > a with moderate angle
        SetAxisRatios(1.3f, 1.8f, 70);
    }

    public void SetFlattenedMono()
    {
        // a > b > c with small angle
        SetAxisRatios(0.7f, 0.5f, 85);
    }

    public void SetHighAngleMono()
    {
        // Nearly orthogonal (close to orthorhombic)
        SetAxisRatios(1.2f, 0.9f, 88);
    }

    public void SetLowAngleMono()
    {
        // Very oblique angle
    ...
    // Educational methods to demonstrate monoclinic properties
    public void ShowAngleEffect()
    {
        Debug.Log($"Current gamma angle: {generator.gamma}°. Monoclinic systems have γ ≠ 90°");
    }

    public void ShowMonoclinicVsOrthorhombic()
    {
        Debug.Log("Monoclinic: α = β = 90°, γ ≠ 90°. Orthorhombic: α = β = γ = 90°");
    }
}